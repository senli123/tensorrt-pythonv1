...
if __name__=="__main__":
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='./model_zoo/pth/unet_carvana_scale0.5_epoch1.pth', help='pytorch weights model.pth path(s)')
    parser.add_argument('--save-trt-weights', type=str, default='./model_zoo/wts/unet_carvana_scale0.5_epoch1.wts', help='save path for tensorrt weights')
